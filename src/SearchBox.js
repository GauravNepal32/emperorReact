          ...
          <div className=''>
            <div className='row g-1'>
              <div className='col-lg-3 col-md-4 col-12'>
                <select
                  className='selectpicker text-black fw-bold w-100'
                  name='degreeName'
                  data-live-search='true'
                  id='degreeName'>
                  <option className=' fw-bold' value='' disabled selected>
                    Choose Degree
                  </option>
              ...
              <div className='col-lg-2 col-12 d-flex'>
                {" "}
                <button className='search-box-btn w-100 text-uppercase fw-bold'>
