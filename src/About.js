  ...
  return (
    <div class='main-container my-5'>
      <div class='container px-sm-4'>
          ...
          <div class='container'>
            <div class='row row-cols-md-2 row-cols-1'>
              <div class='col order-1'>
                <img src={team} class='img-fluid' alt='' srcset='' />
              </div>
              <div class='col  order-0'>
                <div class='h-100 d-flex flex-column justify-content-center align-content-center'>
                  <h1 class='main-heading'>We're result driven team</h1>
                  <p class='info-paragraph mt-5'>
        ...
        <div class='row mb-200'>
          <h1 class='text-center main-heading text-wrap'>
            Our goal to eliminate obstacles so <br /> you may create your own
            future.
          </h1>
          <p class='text-center mt-5 info-paragraph'>
        ...
        <div class='row mb-200 ceo-message-container'>
          <div class='row row-cols-md-2 row-cols-1'>
            <div class='col order-0 d-md-block d-none'>
              <div class='ceo-image-container'>
                <div class='ceo-image-wrapper mx-auto'>
                  <img src={ceo} class='img-fluid' alt='' srcset='' />
                </div>
                <h4 class='text-center mt-4'>Keshav Dhungana</h4>
              </div>
            </div>
            <div class='col  order-1'>
              <div class='h-100 d-flex flex-column justify-content-center align-content-center'>
                <h1 class='main-heading text-md-start text-center'>
                  Message from Our CEO
                </h1>
                <div class='ceo-image-container d-md-none d-block mt-5'>
                  <div class='ceo-image-wrapper mx-auto'>
                    <img src={ceo} class='img-fluid' alt='' srcset='' />
                  </div>
                  <h4 class='text-center mt-4'>Keshav Dhungana</h4>
        ...
        <div class='row mb-200'>
          <div class='row row-cols-md-2 row-cols-1'>
            <div class='col order-1 p-md-5'>
              <div class='row row-cols-2 g-4'>
                <div class='col pillar-container pillar-team d-flex justify-content-between'>
                  <div>
                    <span class='material-icons'>groups</span>
                  </div>
                  <h6>Team</h6>
                </div>
                <div class='col pillar-container pillar-trust d-flex justify-content-between'>
                  <div>
                    <span class='material-icons'>favorite</span>
                  </div>
                  <h6>Trust & Respect</h6>
                </div>
                <div class='col pillar-container pillar-customer d-flex justify-content-between'>
                  <div>
                    <span class='material-icons'>person</span>
                  </div>
                  <h6>Customers</h6>
                </div>
                <div class='col pillar-container pillar-trans d-flex justify-content-between'>
                  <div>
            ...
            <div class='col  order-0'>
              <div class='h-100 d-flex flex-column justify-content-center align-content-center'>
                <h1 class='main-heading text-center text-md-start'>
                  How are we successful?
                </h1>

                <p class='info-paragraph mt-5 text-center text-md-start'>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Provident sapiente, possimus at, eius reiciendis pariatur
                  architecto quos asperiores enim dolor animi quidem sunt
                  dignissimos.
